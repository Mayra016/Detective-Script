...
class Subject:
  ...
  def getMurder(self):  
    return self.isMurder

  def getSubj(self):
    return self.subj  

def uploadSubjsData(subj, currentLevel):
    if subj.getSubj() == 1:
      cell_name = sheet_obj.cell(row = currentLevel, column = 1);
      cell_name.value = str(subj.getName());
      cell_place = sheet_obj.cell(row = currentLevel, column = 4);
      cell_place.value = str(subj.getPlace());
    ...
    if subj.getMurder() == True:
      cell_murder = sheet_obj.cell(row = currentLevel, column = 15);
      cell_murder.value = str(subj.getName())  

def uploadClues(currentLevel, clue1, clue2, clue3, clue4, clue5):
...
def writeLevels(initial, final):
  ...
  while currentLevel <= final:
    ...
    uploadSubjsData(subject1, currentLevel)
    uploadSubjsData(subject2, currentLevel)
    uploadSubjsData(subject3, currentLevel)
    uploadClues(currentLevel, clue1, clue2, clue3, clue4, clue5)
    wb_obj.save("/content/drive/MyDrive/Colab Notebooks/Detective.xlsx")
    print(subject1.name)
    print(subject1.obj)
    print(subject1.place)
    print(subject1.gender)
    print(subject2.name)
    print(subject2.obj)
    print(subject2.place)
    print(subject2.gender)
    print(subject3.name)
    print(subject3.obj)
    print(subject3.place)
    print(subject3.gender)
    print(clue1)
    print(clue2)
    print(clue3)
    print(clue4)
